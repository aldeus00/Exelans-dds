...
gf.print_with_gradient(exelans.renderText("EXELANS"), Color("#E13556"), Color("#FFDD00"))
print("[" + B + "" + R + "#" + N + "] " + B + "" + R + "Author : ༒⃕️⃝ᴇͥxͣᴇͫʟᴀɴs࿐" + N + "   Exelans Dos From - " + B + "" + R + "WH1T3" + N)
print()
print("\033[32m================================================================\033[0m")
print("\033[32mTool devoloped : ༒⃕️⃝ᴇͥxͣᴇͫʟᴀɴs࿐ \033[0m")
print("\033[33mTelegram       : @redcavalry")
print("\033[33mKanal          : @kolezyumoffical\033[0m")
print("\033[32m================================================================\033[0m")
print()
